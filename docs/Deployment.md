...
**RiskRule Platform — Deployment Architecture, Environment Configuration & Operations Guide**
**Document ID:** DEP-001
**Version:** 2.0
**Status:** Active
...
RiskRule uses a **monorepo-style** layout with a Vite frontend and an Express backend, both deployed on Vercel.
...
| `ALLOWED_ORIGINS` | No | `http://localhost:5173` | Comma-separated CORS origins | `http://localhost:5173,https://riskrule.vercel.app` |
