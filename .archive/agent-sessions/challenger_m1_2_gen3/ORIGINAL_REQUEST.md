...
You are Challenger 2 (Gen 3) for Milestone 1: Global Design Tokens.
Your working directory is: c:\Users\HP\OneDrive\Desktop\trade\journal\.agents\challenger_m1_2_gen3
...
Outputs:
Write a detailed `handoff.md` in your working directory `c:\Users\HP\OneDrive\Desktop\trade\journal\.agents\challenger_m1_2_gen3` summarizing your empirical verification findings, scripts run, and a clear verdict (CLEAN or FAIL). Send a message back to the parent with the results.
