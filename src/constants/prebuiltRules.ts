...
export const PREBUILT_RULE_CATEGORIES = [
  { id: 'all', label: 'All Rules (62)' },
  { id: 'beginner', label: '⭐ Beginner Essentials (12)' },
  { id: 'risk', label: '🛡️ Risk & Capital (8)' },
  { id: 'open_gaps', label: '🌅 Market Open & Gaps (6)' },
  { id: 'breakout_traps', label: '🎯 Breakouts & Traps (6)' },
  { id: 'trends', label: '📈 Trends & Momentum (6)' },
  { id: 'range_chop', label: '🌊 Choppy & Sideways (5)' },
  { id: 'news_events', label: '📰 News & High Volatility (5)' },
  { id: 'expiry_options', label: '⚡ Expiry & Options (6)' },
  { id: 'management', label: '📊 Trade Management (6)' },
  { id: 'drawdowns', label: '📉 Drawdowns & Tilts (5)' },
  { id: 'winning_greed', label: '🏆 Winning & Greed Control (4)' },
  { id: 'psychology', label: '🧠 Mindset & Stress (6)' },
  { id: 'routine', label: '⏰ Daily Prep & Journaling (5)' },
] as const;
