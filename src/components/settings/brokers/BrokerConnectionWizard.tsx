          ...
          {step === 6 && (
            <div className="py-8 flex flex-col items-center justify-center text-center space-y-6">
              ...
              <div className="max-w-md space-y-2">
                ...
                <p className="text-xs text-tertiary leading-relaxed">
                  Your brokerage account has been successfully verified, encrypted, and synced with your RiskRule journal. Automated background observers are actively monitoring token health.
                </p>
              </div>
