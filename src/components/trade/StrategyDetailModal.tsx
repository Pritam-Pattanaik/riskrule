            ...
            <div className="bg-iris/8 border border-iris/20 rounded-xl p-4 flex items-start gap-3">
              ...
              <div className="text-xs leading-relaxed">
                ...
                <p className="text-secondary">
                  This strategy is maintained by TradeVault as an institutional default setup and cannot be directly modified or deleted. You can click <strong className="text-primary font-medium">Clone as Custom Strategy</strong> below to create your own editable copy.
                </p>
              </div>
            </div>
          ) : (
